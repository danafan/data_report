	...
	export default{
		data(){
			return{
				...
				'数据更新方式：每小时一更新',
				'今日订单数：付款日期当天的下单内部订单号数，订单状态包括：已发货、发货中、已付款待审核和异常',
				'今日已发货：付款日期当天的已发货的内部订单号数',
				'今日发货中：付款日期当天的发货中的内部订单号数',
				'今日未发货：付款日期当天的已付款待审核和异常的内部订单号数',
				'今日发货率：今日已发货/今日订单数',
				'今日缺货率：今日异常订单数/今日订单数',
				'今日档口款缺货率：异常订单中，档口款订单数/(档口款订单数+自有货品订单数）',
				'今日自有货品缺货率：异常订单中，自有货品订单数/(档口款订单数+自有货品订单数）'
				],
				pickerOptions: {
					shortcuts: [{
						text: '当月',
