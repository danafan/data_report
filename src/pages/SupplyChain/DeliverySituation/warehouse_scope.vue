	...
	export default{
		data(){
			return{
				...
				'当日订单总数：以付款日期统计，当天付款的订单所有状态的内部订单号数，订单状态包括：已发货、发货中、已付款待审核和异常',
				'当日已发货：以付款日期统计，当天付款的订单已发货的内部订单号数',
				'当日发货中：以付款日期统计，当天付款的订单发货中的内部订单号数',
				'当日未发货：以付款日期统计，当天付款的订单已付款待审核和异常的内部订单号数',
				'当日发货率：当日已发货/当日订单总数',
				'当日缺货率：当日异常订单数/当日订单总数',
