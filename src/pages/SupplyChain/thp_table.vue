	...
	<div>
		<el-tabs v-model="activeTab" @tab-click="checkTab">
			<el-tab-pane :label="item.menu_name" lazy :name="item.web_url" class="tab_pane_box" v-for="item in menu_list">
				<ThpUse v-if="item.web_url == 'thp_use'"/>
				<ThpSales v-if="item.web_url == 'thp_sales'"/>
			</el-tab-pane>
		</el-tabs>
	</div>
</template>
...
<script>
	import ThpUse from './ThpTable/thp_use.vue'
	import ThpSales from './ThpTable/thp_sales.vue'
	export default{
		data(){
			return{
				activeTab:"thp_use",
