	...
	<div>
		<el-tabs v-model="activeTab" @tab-click="checkTab">
			<el-tab-pane :label="item.menu_name" lazy :name="item.web_url" class="tab_pane_box" v-for="item in menu_list">
				<Bpcgxd dept="si_dept" v-if="item.web_url == 'bpcgxd'"/>
				<Thkspmx dept="si_dept" v-if="item.web_url == 'thkspmx'"/>
				<ZxbpThdzb dept="si_dept" v-if="item.web_url == 'zxbp_thdzb'"/>
				<Zxbphgl dept="si_dept" v-if="item.web_url == 'zxbphgl'"/>
			</el-tab-pane>
		</el-tabs>
	</div>
</template>
