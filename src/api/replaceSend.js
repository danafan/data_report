...
let path = {	
	...
	dfOrderTotal:'replacesend/df_order_total',			//分仓系统看板-头部汇总统计
	dfShopKsbmGys:'replacesend/df_shop_ksbm_gys',		//店铺、商品、供应商分仓排行
	dfShopKsbmGysExport:'replacesend/df_shop_ksbm_gys_export',	//店铺、商品、供应商分仓排行导出
	dfAverageDelivery:'replacesend/df_average_delivery',	//分仓看板发货平均时效统计
	dfAverageDeliveryExport:'replacesend/df_average_delivery_export',	//分仓看板发货平均时效统计导出
	dfOverTime:'replacesend/df_over_time',					//分仓系统看板超时未发统计
	dfOverTimeExport:'replacesend/df_over_time_export',		//分仓系统看板超时未发统计导出
	dfShopGysList:'replacesend/df_shop_gys_list',			//分仓系统店铺/供应商明细表接口
	dfShopGysExport:'replacesend/df_shop_gys_export',		//分仓系统店铺/供应商明细表导出
	todayChart:'replacesend/df_chart_today',				//今天分仓订单图表
	monthChart:'replacesend/df_chart_month',				//30天分仓订单图表
	...
	dfAreaChart:'replacesend/df_area_chart',				//地区分仓订单趋势图
}							
export default{
	//订单列表
	orderList(params){
